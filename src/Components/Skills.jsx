  ...
  return (
    <div id="Skills" className="w-full h-fit  mt-5 p-[5vw] ">
      ...
      <div className="leading-[6vw] flex mt-10 max-md:mt-5 mb-10  items-end gap-4 font-love">
        ...
        <h1 className="whitespace-nowrap text-[6vmax]  text-[#8FEC98]">
          Interest
        </h1>
      </div>
      <div className="w-full h-fit px-10 py-10 max-md:px-[0px] max-md:grid max-md:grid-cols-4  bg-[#86868678] text-[1.5vw] max-md:text-[9px] rounded-xl">
        <div className="w-[8vw] max-md:w-[15vw]   inline-block  max-md:m-2 max-md:mb-5  mr-10  h-[8vw] max-md:h-[15vw]  ">
          <img
            className="  h-full "
